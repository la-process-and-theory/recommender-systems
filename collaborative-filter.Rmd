...
```{r}
my.name <- "Indira Batayeva" #Input your name as it appears in the data set
...
#C1<- C1[, -c(1,2)]
#couldn't solve this > Error in data.frame(I3, D3$difficulty) : arguments imply differing number of rows: 364, 350
