...
```{r}
diff <- read.csv("D:/Github/4051/recommender system/recommender-systems/difficulty.csv")
inte <- read.csv("D:/Github/4051/recommender system/recommender-systems/interest.csv")
```
