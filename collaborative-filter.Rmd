...
```{r}
my.name <- "Chengxuan Hu" #Input your name as it appears in the data set
...
I3<-I1[-c(49,50),]
D3<-D1[-c(49,50),]
I4 <- gather(I3,unit,interest,3:9)
D4 <- gather(D3,name,difficulty,3:9)

I4<-unite(I4,"name",first,last, sep = " ")
D4<-unite(D4,"name",first,last, sep = " ")
