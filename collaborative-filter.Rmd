...
#I decided to change all missing values coded as zero to 'NA' because cosine similarity is a measure of similarity between two non-zero vectors
...
```{r}
my.uni <-"ma3694" #Input your UNI id in here
