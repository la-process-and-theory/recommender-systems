...
```{r}
#From what I gather from the solution (wouldn't have figured it out otherwise) - run PCA with interest and difficulty on different axes and take PC1 as the composite measure.
difficulty2
interest2
