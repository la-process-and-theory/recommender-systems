...
head(rownames(D.SIM[order(D.SIM[unit.name, ], decreasing = TRUE),]), n = 5)#This code orders the column of the matrix corresponding to the given unit according to similarity and returns the top 5 most similar ids for the students who's interests are most similar to yours.
```
