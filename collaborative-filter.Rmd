...
#lsa not working for this laptop, coop used instead

install.packages("coop")
library(coop)

I.SIM <- coop::cosine(I2) #This command generates the cosine similarity values as a new matrix. Click on I.SIM in the Global Environment pane to see what it looks like.
...
```{r}
my.name <- "Jiaying Li" #Input your name as it appears in the data set
...
C1$difficulty[is.na(C1$difficulty)] <- 0
C1$interest[is.na(C1$interest)] <- 0
