...
```{r}
my.name <- "Jiahao Guo" #Input your name as it appears in the data set
...
D3 <- distinct(D3,name, .keep_all= TRUE)#remove duplicate students
I3 <- gather(I3,unit,interest, 2:8)
D3 <- gather(D3, name, difficulty)
