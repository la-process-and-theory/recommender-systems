...
#My missing value is coded with 0, because that will be easier to handle in calculation. If I code with NA, cosine function can't deal with missing values in a vector and some data which are not NA will be not included in the calculation. 
```{r, echo = FALSE}
...
```{r}
my.name <- "Meijuan Zeng" #Input your name as it appears in the data set
...
#Search which item is the most  similar to prediction unit.
