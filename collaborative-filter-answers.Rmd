...
D3 <- gather((D2),name, difficulty, 2:8)
...
C2_PCA <- prcomp(C2,center = TRUE, scale = TRUE)
summary(C2_PCA)
C2_PCA$rotation
C2_PCA$x
C3 <- data.frame(C1$name, C1$uni,C2_PCA$x)
C3$C1.uni <- gsub(".interest","",C3$C1.uni)
C4 <- C3[1:3]
C5 <- spread(C4,C1.name,PC1)
row.names(C5) <- C5$C1.uni
C5$C1.unit <- NULL
C6 <- as.matrix(C5[,-1])
