...
#install.packages("lsa") #You will need to install the lsa package to access the cosine(cos) command.
library(lsa)
I.SIM2 <- cosine(D2) #This command generates the cosine similarity values as a new matrix. Click on I.SIM in the Global Environment pane to see what it looks like.
diag(I.SIM2) <- NA
