...
head(rownames(I.SIM[order(I.SIM[my.name,], decreasing = TRUE),]), n = 5) #This code orders the column of the matrix corresponding to your name according to similarity and returns the top two UNI ids for the students who's interests are most similar to yours
```
