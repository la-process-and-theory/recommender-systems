...
```{r}
my.name <- "Sonali Kamath" #Input your name as it appears in the data set
...
#combining names
I1 <- unite(I1, "name", first,last, sep = " ")#combine names
D1 <- unite(D1,"name",first,last,sep = " ")

#dropping students with blanks
#BlankStudents = c('Luyi Dai','Ziyuan Guo','Anqi Duan','chaoxiong chen')
I3 <- I1[c(1:30,32:44,46:48,51:52),]
D3 <- D1[c(1:30,32:44,46:48,51:52),]
...
head(rownames(C.SIM[order(C.SIM["neuralerest",], decreasing = TRUE),]), n = 1)
