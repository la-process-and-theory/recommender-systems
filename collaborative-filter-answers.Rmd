...
```{r}
my.name <- "Jiali Jin" #Input your name as it appears in the data set
...
D3 <- gather(D1, name, difficulty,3:9)
...
head(rownames(C.SIM[order(C.SIM[4,], decreasing = TRUE),]), n = 1)
